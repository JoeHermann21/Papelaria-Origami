...
alter table usuario add column senha varchar (200);

alter table usuario drop column repeteSenha;
alter table usuario add column repeteSenha varchar (200);

alter table cliente drop column pedido;

alter table produto add column quantMinima int;

alter table produto add column nomeArquivo varchar(100);
alter table produto add column path varchar(200);
