...
<html lang="pt-br">
    ...
    <div id="layoutSidenav_content">
        <div class="container-fluid">
            <h1 class="mt-4">Cadastro de Fabricante</h1>
            <div class="col-lg-6">
            ...
            <%
                String cadFabrimsg = (String) request.getAttribute("cadFabrimsg");
                if (cadFabrimsg != null) {
            %>
            <div class="col-lg-6">
                <div class="checkout__input">
                    <p> <h5 id="titulo"><%= cadFabrimsg%></h5></p>
                </div>
            </div>
            ...
            %>
            <form method="POST" action="/PapelariaOrigami/cadastrarFabricantes">
                <div class="row">
                    <div class="col-lg-8 col-md-6">  
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control py-4" id="inputDescricao" type="text" name="txtDescricao"placeholder="Descrição do Fabricante" />
                        </div>
                        <div class="form-group">
                            <label class="small mb-1" for="inputID">Sigla*</label>
                            <input class="form-control py-4" id="inputSigla" type="text" name="txtSigla"  placeholder="Nome do fabricante" maxlength="4"/>
                        </div>                         
                        <div class="form-group">                        
                            <label class="small mb-1" for="inputID">CNPJ*</label>
                            <input class="form-control py-4" id="inputQuantidade" type="text" 
                                   onblur="javascript: formatarCampo(this);"
                                   name="txtCnpj" placeholder="Digite o CNPJ do fabricante" maxlength="14" />                            
                        </div>                 
