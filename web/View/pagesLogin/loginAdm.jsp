                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-5">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    ...
                                    <div class="card-body">
                                        <form  method="POST" action="http://localhost:8080/PapelariaOrigami/painelControle" name="LoginForm" onsubmit="return validate();">
                                            <div class="form-group" data-validate="Somente Números">
                                                <label class="small mb-1" for="inputNumReg">Número do Registro</label>
                                                <input class="form-control py-4" id="inputNumReg" type="numeric" name="registro"  placeholder="Digite seu número do registro" />
                                            </div>
                                            ...
                                            <div class="form-group d-flex align-items-center justify-content-between mt-4 mb-0">
                                               <input class="btn btn-primary" name="login" type="submit" value="Entrar" name="acao">
                                               <a href="http://localhost:8080/PapelariaOrigami/painelControle">ADM</a>
                                            </div>
                                        </form>
                                    </div>
                                </div>
