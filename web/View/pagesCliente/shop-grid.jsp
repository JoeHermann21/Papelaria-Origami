                    ...
                    <div class="col-lg-12 text-center">
                        <div class="breadcrumb__text">
                            ...
                            <div class="breadcrumb__option">
                                <a href="http://localhost:8080/PapelariaOrigami/shopGrid">Home</a>
                                <span>Shop</span>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="sidebar__item">                                
                                ...
                                <div class="sidebar__item">                                    
                                    <ul>
                                        ...
                                        <li><a href="http://localhost:8080/PapelariaOrigami/categoriaProduto?id=<% out.print(c.getId());%>"><% out.print(c.getDescricao()); %></a></li>  
                                            <%}%>
                                    </ul>
                                </div>
                            </div>
