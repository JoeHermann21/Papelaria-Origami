                            ...
                            <div class="latest-product__text">
                                ...
                                <div class="latest-product__slider owl-carousel">
                                    <div class="latest-prdouct__slider__item">
                                        ...
                                        <tbody>
                                        <tr>
                                         <a href="#"><img src="img/caneca/cane1.jpeg"></a>
                                        ...
                                        <tr>
                                        <a href="#"><img src="img/caneca/cane2.jpeg"></a>
                                            <div class="latest-product__item__text">
                                                <h6>Caneca Naruto</h6>
                                        ...
                                        <tr>
                                        <a href="#"><img src="img/caneca/cane3.jpeg"></a>
                                            <div class="latest-product__item__text">
                                    ...
                                    <div class="latest-prdouct__slider__item">
                                        ...
                                        <tbody>
                                        <tr>
                                        <a href="#"><img src="img/caneca/cane4.jpeg"></a>
                                            <div class="latest-product__item__text">
                                        ...
                                        <tr>
                                        <a href="#"><img src="img/caneca/cane5.jpg">Clique para ver detalhes</a>
                                            <div class="latest-product__item__text">
                                                <h6>Copo Metálico</h6>
                                                <h6>550ml</h6>
                                                <span>$50.00</span>
                                        ...
                                        <tr>
                                        <a href="#"><img src="img/caneca/cane6.jpeg"></a>
                                            <div class="latest-product__item__text">
                                ...
                                <div class="col-lg-4">
                                    <div class="product__discount__item">
                                        <div class="product__discount__item__pic set-bg"
                                            data-setbg="img/caderno/cad1.jpeg">
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-md-6 col-sm-6">
                            <div class="product__item">
                                ...
                                <div class="product__item__text">
                                    <h6><a href="#">Caderno Universitário Estelar
                                                    Capa dura 10cm x 17,5cm 1 unid</a></h6>
                                    <h5>$30.00</h5>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6 col-sm-6">
                            <div class="product__item">
                                ...
                                <div class="product__item__text">
                                    <h6><a href="#">Caneta Bic azul ponta comum 1 unid</a></h6>
                                    <h5>R$1.00</h5>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6 col-sm-6">
                            <div class="product__item">
                                ...
                                <div class="product__item__text">
                                    <h6><a href="#">Caneta Hidrográfica Preta 1 unid Emoit</a></h6>
                                    <h5>$4.00</h5>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6 col-sm-6">
                            <div class="product__item">
                                ...
                                <div class="product__item__text">
                                    <h6><a href="#">Caneta em gel dourada com ponta extra 0,4mm 1 unid CIS</a></h6>
                                    <h5>$8.00</h5>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6 col-sm-6">
                            <div class="product__item">
                                ...
                                <div class="product__item__text">
                                    <h6><a href="#">Caneta 3 pontas: Azu, preto e vermelho BIC 1 unid </a></h6>
                                    <h5>$5.00</h5>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6 col-sm-6">
                            <div class="product__item">
                                ...
                                <div class="product__item__text">
                                    <h6><a href="#">Lápis 3B Faber Castell para desenhos 1 unid</a></h6>
                                    <h5>$2.00</h5>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6 col-sm-6">
                            <div class="product__item">
                                ...
                                <div class="product__item__text">
                                    <h6><a href="#">Conjunto lápis 2B cor metalica 4unid CIS</a></h6>
                                    <h5>$12.00</h5>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6 col-sm-6">
                            <div class="product__item">
                                ...
                                <div class="product__item__text">
                                    <h6><a href="#">Lápis emborrachado contra queda Azul 2B 1 unid CIS</a></h6>
                                    <h5>$6.00</h5>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6 col-sm-6">
                            <div class="product__item">
                                ...
                                <div class="product__item__text">
                                    <h6><a href="#">Lápis 2B com borracha embutida 1 unid CIS</a></h6>
                                    <h5>$30.00</h5>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6 col-sm-6">
                            <div class="product__item">
                                ...
                                <div class="product__item__text">
                                    <h6><a href="#">Tinta Nanquin preta 50ml 1 unid</a></h6>
                                    <h5>$18.00</h5>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6 col-sm-6">
                            <div class="product__item">
                                ...
                                <div class="product__item__text">
                                    <h6><a href="#">Aquarela 12 cores 1 unid Giotto</a></h6>
                                    <h5>$20.00</h5>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6 col-sm-6">
                            <div class="product__item">
                                ...
                                <div class="product__item__text">
                                    <h6><a href="#">Estojo de lápis de cor profissional 64 cores 1 unid Pencil</a></h6>
                                    <h6><a href="#"></a></h6>
                                    <h5>$30.00</h5>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6">
                            <div class="product__item">
                                ...
                                <div class="product__item__text">
                                    <h6><a href="#">Caneta Marcadora Verde Stabilo 1 und</a></h6>
                                    <h5>$18.00</h5>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6 col-sm-6">
                            <div class="product__item">
                                ...
                                <div class="product__item__text">
                                    <h6><a href="#">Papel Canson 20 folhas A3 1 unid</a></h6>
                                    <h5>$20.00</h5>
                                </div>
                            </div>
                        </div>
