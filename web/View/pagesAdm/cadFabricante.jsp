                ...
                <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                    <div class="sb-sidenav-menu">
                        ...
                        <div id="layoutSidenav_content">
                            ...
                            %>
                                <form method="POST" action="/PapelariaOrigami/FabricanteControle">
                                    <div class="row">
                                        <div class="col-lg-8 col-md-6">  
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input class="form-control py-4" id="inputSigla" type="text" name="txtSigla"  placeholder="Nome do fabricante" />
                                            </div>                         
                                            <div class="form-group">
                                                <label class="small mb-1" for="inputID">CNPJ*</label>
                                                <input class="form-control py-4" id="inputQuantidade" type="txt" name="txtCnpj" placeholder="Digite o CNPJ do fabricante" />
                                            </div>
