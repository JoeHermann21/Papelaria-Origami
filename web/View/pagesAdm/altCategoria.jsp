...
<html lang="pt-br">
    ...
    <div id="layoutSidenav_content">
        <div class="container-fluid">
            ...
            <%
                Categoria cate = (Categoria) request.getAttribute("lcate");
            %>
            <form method="POST" action="/PapelariaOrigami/salvarCategoria" >
                <div class="row">
                    <div class="col-lg-8 col-md-6">  
                        <div class="form-group">
                            <div class="form-group">
                                <label class="small mb-1" for="inputID">ID*</label>
                                <input class="form-control py-1" name="txtID" id="ID" readonly="true" value="<%=cate.getId()%>">
                            </div>
                            <div class="form-group">
                                <label class="small mb-1" for="inputID">Descrição*</label>
                                <input class="form-control py-1" name="txtDescricao" id="descricao" value="<%=cate.getDescricao()%>">
                            </div>
                            <div class="form-group">
                                <label class="small mb-1" for="inputID">Sigla*</label>
                                <input class="form-control py-1" type="txt" name="txtSigla" id="qntdd" value="<%=cate.getSigla()%>" maxlength="4">
                            </div>        
