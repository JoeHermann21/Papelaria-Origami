                ...
                <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                    <div class="sb-sidenav-menu">
                        ...
                        <div id="layoutSidenav_content">
                            ...
                            %>
                                <form method="POST" action="/PapelariaOrigami/cadastrarProduto" >
                                    <div class="row">
                                        <div class="col-lg-8 col-md-6">  
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input class="form-control py-1" id="inputPreco" type="number" step="any"  min="0" name="txtPreco" placeholder="Digite o total de unidades" />
                                            </div>
