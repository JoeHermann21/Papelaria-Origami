                  ...
                  <form method="get" action="/Papelaria/ProdutoControle" >
                    <div class="row">
                        <div class="col-lg-8 col-md-6">  
                            <div class="checkout__input">
                                <p>ID</p>
                                <input type="text" name="txtID" id="ID" readonly="true" >
                            </div>
                            <div class="checkout__input">
                            ...
                            <div class="checkout__input">
                                ...
                                <input type="date" name="txtDataEntrada" id="DataEntrada">
                            </div>
                            
                            <div class="checkout__input">
                                <p>Fabricante<span>*</span></p>
                                <input type="text" name="txtFabricante" id="fabricante">
                            </div>
                            
                            <div class="checkout__input">
                                <p>Quantidade<span>*</span></p>
                                <input type="number" name="txtQntdd" id="qntdd">
                            </div>                            
                            
                            <div class="checkout__input">
                                <p>Preço<span>*</span></p>
                                <input type="numeric" name="txtPreco" id="preco">
                            </div>
